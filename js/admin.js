$(function () {
  var vm = new Vue({
    el: '#pk-ddl-table',
// TODO: Change everything from Static fields to customizable fields with autogenerated Names etc. 
    data: {
    ...
    methods: {
      save: function() {
        this.$http.post('admin/pk-ddl/save', { entries: this.entries }, function() {
